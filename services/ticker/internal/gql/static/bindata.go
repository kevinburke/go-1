...
func graphiqlHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "graphiql.html", size: 1182, mode: os.FileMode(0644), modTime: time.Unix(1566540991, 0)}
...
func schemaGql() (*asset, error) {
	...
	info := bindataFileInfo{name: "schema.gql", size: 2400, mode: os.FileMode(0644), modTime: time.Unix(1566540991, 0)}
