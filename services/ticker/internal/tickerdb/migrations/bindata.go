...
func migrations20190404184050InitialSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/20190404184050-initial.sql", size: 821, mode: os.FileMode(0644), modTime: time.Unix(1566540991, 0)}
...
func migrations20190405112544Increase_asset_code_sizeSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/20190405112544-increase_asset_code_size.sql", size: 366, mode: os.FileMode(0644), modTime: time.Unix(1566540991, 0)}
...
func migrations20190408115724Add_new_asset_fieldsSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/20190408115724-add_new_asset_fields.sql", size: 1371, mode: os.FileMode(0644), modTime: time.Unix(1566540991, 0)}
...
func migrations20190408155841Add_issuers_tableSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/20190408155841-add_issuers_table.sql", size: 950, mode: os.FileMode(0644), modTime: time.Unix(1566540991, 0)}
...
func migrations20190409152216Add_trades_tableSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/20190409152216-add_trades_table.sql", size: 628, mode: os.FileMode(0644), modTime: time.Unix(1566540991, 0)}
...
func migrations20190409172610Rename_assets_desc_descriptionSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/20190409172610-rename_assets_desc_description.sql", size: 168, mode: os.FileMode(0644), modTime: time.Unix(1566540991, 0)}
...
func migrations20190410094830Add_assets_issuer_account_fieldSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/20190410094830-add_assets_issuer_account_field.sql", size: 344, mode: os.FileMode(0644), modTime: time.Unix(1566540991, 0)}
...
func migrations20190411165735Data_seed_and_indicesSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/20190411165735-data_seed_and_indices.sql", size: 1522, mode: os.FileMode(0644), modTime: time.Unix(1566540991, 0)}
...
func migrations20190425110313Add_orderbook_statsSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/20190425110313-add_orderbook_stats.sql", size: 749, mode: os.FileMode(0644), modTime: time.Unix(1566540991, 0)}
...
func migrations20190426092321Add_aggregated_orderbook_viewSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/20190426092321-add_aggregated_orderbook_view.sql", size: 831, mode: os.FileMode(0644), modTime: time.Unix(1566540991, 0)}
