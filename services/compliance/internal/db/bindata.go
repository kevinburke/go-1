...
// sources:
// latest.sql (7.872kB)
// migrations/01_init.sql (992B)
// migrations/02_auth_data.sql (272B)
// migrations/03_table_names.sql (436B)
...
func latestSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "latest.sql", size: 7872, mode: os.FileMode(0644), modTime: time.Unix(1566540991, 0)}
...
func migrations01_initSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/01_init.sql", size: 992, mode: os.FileMode(0644), modTime: time.Unix(1566540991, 0)}
...
func migrations02_auth_dataSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/02_auth_data.sql", size: 272, mode: os.FileMode(0644), modTime: time.Unix(1566540991, 0)}
...
func migrations03_table_namesSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/03_table_names.sql", size: 436, mode: os.FileMode(0644), modTime: time.Unix(1566540991, 0)}
